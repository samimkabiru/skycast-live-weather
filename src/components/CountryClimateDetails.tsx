  ...
  return (
    <div className="h-full px-7 py-8">
      ...
      {weatherData.map((data) => (
        <div
          key={data.property}
          className="sidebar-bg bg-gradient-to-br from-[#274369]/40 to-[#2B4B85]/40 backdrop-blur-xs text-white rounded-2xl p-4 shadow my-5 flex justify-start ring ring-[#50648b]"
        >
